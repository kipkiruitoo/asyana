  ...
  <body class="sidebar-mini skin-blue {{ (session('menu_state')!='open') ? 'sidebar-mini sidebar-collapse' : ''  }}">
    <div class="wrapper">
      ...
      <footer class="main-footer hidden-print">
        ...
        <a target="_blank" href="https://kipkiruitoo.github.io" rel="noopener">&copy; 2019, GOATs Team</a>  made with <i class="fa fa-heart" style="color: #a94442; font-size: 10px"></i> using <a href="https://twitter.com/snipeitapp" rel="noopener">@snipeitapp</a>.
      </footer>
